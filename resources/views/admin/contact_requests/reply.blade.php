...
@section('title', settings()->website_title . ' | ' . __('words.create_item'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('contact_requests.index') }}" class="text-muted">{{ __('words.show_items') }}</a>
            </li>
            <li class="breadcrumb-item">
                <span class="text-muted">{{ __('words.create_item') }}</span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
