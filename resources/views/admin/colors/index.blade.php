...
@section('title', settings()->website_title . ' | ' . __('words.colors'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <span class="text-muted">{{ __('words.show_colors') }}</span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
            ...
            <div class="card-toolbar">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    @permission('create-colors')
                        <a href="{{ route('colors.create') }}" class="btn btn-primary font-weight-bolder">
                ...
                <tbody>
                    @foreach ($colors as $key => $color)
                        <tr>
                            ...
                            <td>{{ formatDate($color->created_at) == formatDate($color->updated_at) ? '--' : formatDate($color->updated_at) }}
                            </td>
                            <td nowrap="nowrap">
