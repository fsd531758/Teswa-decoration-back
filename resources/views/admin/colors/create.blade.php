...
@section('title', settings()->website_title . ' | ' . __('words.create_color'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <span class="text-muted">{{ __('words.create_color') }}</span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="card card-custom mb-2">
        <div class="card-header card-header-tabs-line">
            <div class="card-title">
                <h3 class="card-label">{{ __('words.create_color') }}</h3>
            </div>
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-1">
                    ...
                    <input type="color" class="form-control form-control-color p-2" name="hex" id="exampleColorInput"
                        value="{{ old('hex') }}">
                    @error('[hex]')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
