        ...
        <div class="card card-custom">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <a href="{{ $product->image }}" data-toggle="lightbox" data-title="{{ $product->title }}"
                                data-gallery="gallery">
                                <img src="{{ $product->image }}" class="img-fluid mb-2 image-galley"
            ...
            @permission('update-products')
                <div class="card-footer">
                    <div class="row">
                        <div class="col-4">
                            <a href="{{ route('products.edit', $product->id) }}" class="btn btn-block btn-outline-info">
                                {{ __('words.edit') }}
                            </a>
                        </div>
                    </div>
