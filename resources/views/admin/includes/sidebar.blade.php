    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                {{-- service routes start --}}
                @permission('read-experiences')
                    <li class="menu-item menu-item-submenu {{ request()->routeIs('experiences.*') ? 'menu-item-open menu-item-here' : '' }}"
                        aria-haspopup="true" data-menu-toggle="hover">
                        <a href="javascript:;" class="menu-link menu-toggle">
                            <i class="fas fa-star svg-icon menu-icon"></i>
                            <span class="menu-text">{{ __('words.experiences') }}</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="menu-submenu">
                            <i class="menu-arrow"></i>
                            <ul class="menu-subnav">
                                ...
                                @permission('read-experiences')
                                    <li class="menu-item  {{ request()->routeIs('experiences.index') ? 'menu-item-active' : '' }}"
                                        aria-haspopup="true">
                                ...
                                @permission('create-experiences')
                                    <li class="menu-item  {{ request()->routeIs('experiences.create') ? 'menu-item-active' : '' }}"
                                        aria-haspopup="true">
