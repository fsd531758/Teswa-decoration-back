...
@section('title', settings()->website_title . ' | ' . __('words.show_slider'))
@section('breadcrumb')
    <div class="d-flex align-items-baseline flex-wrap mr-5">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item">
                <span class="text-muted">{{ __('words.show_slider') }}</span>
            </li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    ...
    <div class="card card-custom card-stretch gutter-b">
        <div class="card-header card-header-tabs-line">
            <div class="card-title">
                <h3 class="card-label">{{ __('words.show_slider') }}</h3>
            </div>
        ...
        <div class="card card-custom">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0">{{ formatDate($slider->created_at) }}</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-7 bg-light p-5 rounded h-100">
                            ...
                            <p class="m-0">
                                {{ formatDate($slider->created_at) == formatDate($slider->updated_at) ? '--' : formatDate($slider->updated_at) }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-8">
                        <a href="{{ $slider->image }}" data-toggle="lightbox" data-title="{{ $slider->title }}"
                            ...
                            <img src="{{ $slider->image }}" class="img-fluid mb-2 image-galley"
            ...
            @permission('update-sliders')
                <div class="card-footer">
                    <div class="row">
                        <div class="col-4">
                            <a href="{{ route('sliders.edit', $slider->id) }}" class="btn btn-block btn-outline-info">
                                {{ __('words.edit') }}
                            </a>
                        </div>
                    </div>
