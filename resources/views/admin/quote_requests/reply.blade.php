...
@section('form_action', route('quote_requests.send_mail', $quote_request->id))
@section('form_type', 'POST')

@section('form_content')
    @method('post')
    <div class="card card-custom mb-2">
        <input type="hidden" name="id" value="{{ $quote_request->id }}">
            ...
            <div class="card-title w-100">
                <div class="row w-100">
                    <div class="col-12 col-md-6 col-lg-12 col-xl-6 my-2 text-capitalize">
                            ...
                            <span class="font-weight-light">{{ $quote_request->fname . ' ' . $quote_request->lname }}</span>
                    </div>
                    <div class='col-12 col-md-6 col-lg-12 col-xl-6 my-2'>
                            <span class="card-label">{{ __('words.email') }} : </span>
                            <span class="font-weight-light">{{ $quote_request->email }}</span>
                    </div>
                </div>
            </div>
