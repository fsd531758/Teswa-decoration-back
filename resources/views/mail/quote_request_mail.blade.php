                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        {{ __('words.request_details_from') }} :
                                                                        {{ $quote_request['fname'] }}
                                                                        {{ $quote_request['lname'] }}</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table
                                                            ...
                                                            <td align="{{(App::isLocale('ar') ? 'right' : 'left')}}"
                                                                style="padding:20px;Margin:0"><h4
                                                                    ...
                                                                    {{__('words.contact_details')}} : {{$quote_request->fname}} {{$quote_request->lname}}</h4>
                                                            </td>
                                                        </tr> --}}
                                                            <tr style="border-collapse:collapse">
                                                                <td align="{{ App::isLocale('ar') ? 'right' : 'left' }}"
                                                                    ...
                                                                    <table
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                                ...
                                                                                <strong> {{ __('words.first_name') }}
                                                                                    : </strong>{{ $quote_request['fname'] }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                                style="padding:0;Margin:0;font-size:14px;line-height:21px;text-transform:capitalize">
                                                                                <strong> {{ __('words.last_name') }}
                                                                                    : </strong>{{ $quote_request['lname'] }}
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                                ...
                                                                                <strong>{{ __('words.phone') }}:
                                                                                    ...
                                                                                    dir="ltr">{{ $quote_request['phone'] }}</span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td
                                                                                ...
                                                                                <strong>{{ __('words.message') }}
                                                                                    :
                                                                                </strong><br />{{ $quote_request['message'] }}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <p
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-footer-body" cellspacing="0" cellpadding="0" align="center"
                                    bgcolor="#CF9D07"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#CF9D07;width:600px;color: #ffffff">
                                    <tr style="border-collapse:collapse">
                                        <td align="{{ App::isLocale('ar') ? 'right' : 'left' }}"
